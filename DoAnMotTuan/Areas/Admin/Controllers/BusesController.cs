...
namespace DoAnMotTuan.Areas.Admin.Controllers
{
    [Authorize]
    public class BusesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BenXeA,BenXeB,ThoiGianA,ThoiGianB")] Bus bus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BenXeA,BenXeB,ThoiGianA,ThoiGianB")] Bus bus)
        {
            if (ModelState.IsValid)
            {
